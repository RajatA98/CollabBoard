...
export interface ContextMenuProps {
  ...
  objectType?: 'sticky' | 'rectangle' | 'text' | 'circle' | 'line' | 'triangle' | 'star' | 'frame' | 'pen';
  onEditText?: () => void;
  onCopy?: () => void;
  onCut?: () => void;
  onPaste?: () => void;
...
export function ContextMenu({
  ...
  return (
    ...
    >
      {(objectType === 'sticky' || objectType === 'text' || objectType === 'frame') && onEditText && (
        <button
          type="button"
        ...
        >
          {objectType === 'frame' ? 'Rename' : 'Edit Text'}
        </button>
      )}
      {onCopy && (
        <button
