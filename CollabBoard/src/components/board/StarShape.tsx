import { Star, Group, Rect, Text } from 'react-konva';
...
export function StarShape({ object, isSelected, onSelect, onUpdate, onDoubleClick, onRightClick, onDragStart, onDragMove, onDragEndExtra, remoteTransform }: StarShapeProps) {
